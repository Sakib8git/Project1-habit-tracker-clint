        ...
        <div className="max-w-5xl mx-auto">
          {feedbacks.length === 0 ? (
            <div className="text-center text-xl text-gray-500 py-12">
               No feedback available at the moment.<br />
              Be the first to share your experience and help others build better habits!
            </div>
          ) : (
            <div className="grid gap-6 md:grid-cols-3">
              {feedbacks.map((fb) => (
                <div key={fb._id} className="card">
                  ...
                  <p className="text-base-700 italic mb-4 z-10 relative">
                    "{fb.entry}"
                  </p>
