      ...
      <div className="flex flex-wrap justify-center gap-8">
        {habits.map((habit, index) => (
          ...
          >
            ...
            ></div>
            <p className="font-semibold text-base-800 tracking-wider group-hover:text-base-900 text-xl">
              {habit.title}
            </p>
            <p className="font-semibold text-base-600 text-xs text-center group-hover:text-base-800">
              {habit.description}
            </p>
            {habit.isPublic && (
              <p className="text-xs text-base-500 italic group-hover:text-base-700">
